  ...
  const services = [
    {
      ...
      description: "Nemo enim ipsam voluptatem quia voluptas sit superintax qui odi aut fugit, sed quid imperduntur magni doloresios qui intonar voluptatem.",
      cta: "Learn more",
      icon: <FaBolt className="service-icon" />
    },
    {
      title: "Mantenimiento",
      description: "Amet, consectetur adipiscing elit, sed do eiusmod temps inindiquant ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.",
      cta: "Learn more",
      icon: <FaTools className="service-icon" />
    },
    {
      title: "Remodelación de instalación eléctrica",
      description: "Consequinum magni doloresios qui intonar voluptatem aqui metatur. Nouse porno obliguam est, qui odiorem ipsum quia dolor.",
      cta: "Learn more",
    ...
    <div className="instalaciones-container">
      <section className="hero-section">
        <div className="hero-content">
          <button className="cta-button">Solicitar asesoría</button>
        </div>
      </section>
      ...
      <section className="expert-section">
        <h2>Los expertos en instalaciones electricas y mantenimiento</h2>
        <p className="expert-intro">
          Ofrecemos dos tipos de servicios en este ambito ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
        </p>
